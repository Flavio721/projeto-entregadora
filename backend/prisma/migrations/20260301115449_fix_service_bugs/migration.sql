/*
  ...
  - The values [CREATED] on the enum `Delivery` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Delivery_new" AS ENUM ('PENDING', 'IN_DELIVERY', 'DELIVERED');
